...
exports.buscarEmpleado = async (req, res, next) => {
 ...
 INNER JOIN tbl_personas ON tbl_personas.cod_persona = tbl_empleados.cod_persona  where rtn_persona like  '%${rtn}%'  and  tipo_persona = 'empleado'  and   estado_empleado = 'Activo';`;
  try {
